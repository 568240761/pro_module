...
open class BaseVideoPlayer : FrameLayout, IVideoPlayer {
    ...
    fun setOnCompletionListener(listener: IMediaPlayer.OnCompletionListener? = null) {
        mOnCompletionListener = IMediaPlayer.OnCompletionListener { p0 ->
            LogUtil_d(this@BaseVideoPlayer.javaClass.simpleName,"IMediaPlayer.OnCompletionListener")
            mCurrentState = STATE_PLAYBACK_COMPLETED
            listener?.onCompletion(p0)
        }
    ...
    fun setOnErrorListener(listener: IMediaPlayer.OnErrorListener? = null) {
        mOnErrorListener = IMediaPlayer.OnErrorListener { p0, p1, p2 ->
            LogUtil_d(this@BaseVideoPlayer.javaClass.simpleName,"IMediaPlayer.OnErrorListener")
